...
solar = pd.read_csv("C:\\Users\\HP\\solarpowergeneration.csv")
...
grid_search = GridSearchCV(estimator=Gb, param_grid=parameters, cv=5, n_jobs=-1, verbose=2)
...
joblib.dump(Gb,'solarproject.pkl')
...
streamlit_code = """ # Your Streamlit code here """
